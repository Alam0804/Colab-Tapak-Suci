...
<table  border="1" width="100%">
	...
	<tr>
		...
		<td bgcolor="yellow"><center> SUDUT KUNING</center></td>
		<td bgcolor="blue"><center>SUDUT BIRU</center></td>
	...
	<tr <?php if($no % 2 == 0) { echo "bgcolor=#eeeeee"; } ?>>
		...
		<td rowspan="2"><center><?php echo $jadwal['kelas']; ?></center></td>
		<td><center><?php echo $jadwal['nm_merah']; ?></center></td>
		<td><center><?php echo $jadwal['nm_biru']; ?></center></td>
		<td rowspan="2"><center><?php echo $jadwal['pemenang']; ?></center></td>
	</tr>
	<tr <?php if($no % 2 == 0) { echo "bgcolor=#eeeeee"; } ?>>
		<td><center><?php echo $jadwal['kontingen_merah']; ?></center></td>
		<td><center><?php echo $jadwal['kontingen_biru']; ?></center></td>
	</tr>
	</tbody>
	<?php } ?>
</table>
